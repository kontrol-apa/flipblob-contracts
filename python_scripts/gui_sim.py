...
num_flips_slider = ttk.Scale(frame, from_=10, to_=50000, orient=tk.HORIZONTAL, length=300, command=lambda e: update_label(num_flips_slider, num_flips_var))
...
start_treasury_slider = ttk.Scale(frame, from_=100, to_=20000, orient=tk.HORIZONTAL, length=300, command=lambda e: update_label(start_treasury_slider, start_treasury_var))
...
network_cost_slider = tk.Scale(frame, from_=0.1, to_=5, orient=tk.HORIZONTAL, length=300, resolution=0.05)
