...
use flipblob::erc20::erc20::{MockERC20ABIDispatcher, MockERC20ABIDispatcherTrait};
...
fn deploy_flip_and_mocketh_usdc() -> (ContractAddress, ContractAddress, ContractAddress) {
    ...
    let usdc_safe_dispatcher = MockERC20ABIDispatcher { contract_address: *addresses.at(0) };
...
fn approve_and_mint(
    ref erc20_safe_dispatcher: MockERC20ABIDispatcher,
    flip_contract_address: @ContractAddress,
    erc20_contract_address: @ContractAddress,
    amount: u256
) {
...
fn test_single_erc20() {
    ...
    let mut meth_safe_dispatcher = MockERC20ABIDispatcher {
...
fn test_double_erc20() {
    ...
    let mut usdc_safe_dispatcher = MockERC20ABIDispatcher {
    ...
    let min_bet_amount_meth: u128 = 1000000;
    let min_bet_amount_usdc: u128 = 1000000;
...
fn test_multi_bet() {
    ...
    let mut index = 0;
    let mut bet = min_bet_amount_meth;
    let mut times = 10;
