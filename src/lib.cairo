...
mod Flip {
    ...
    const treasury_addy: felt252 =
        0x05fd781a9fb5a87e7eff097d25860d6ab5d5662235b2e49189565c822f4c6fc8;
    ...
    fn constructor(ref self: ContractState) {
        let addy: ContractAddress = starknet::contract_address_const::<0x05fd781a9fb5a87e7eff097d25860d6ab5d5662235b2e49189565c822f4c6fc8>();
        let mut unsafe_state = Ownable::unsafe_new_contract_state();
        InternalImpl::initializer(ref unsafe_state,addy);
    }
    ...
    impl FlipImpl of super::IFlip<ContractState> {
        ...
        fn issue_request(
            ...
            let addy: ContractAddress =
              starknet::contract_address_const::<0x034e31357d1c3693bda06d04bf4c51557514ECed5A8e9973bDb772f7fB978B36>();
            IWETHDispatcher {
              contract_address: addy
            }.transferFrom(issuer, treasury_addy, wager_amount);
            let current_request_id: felt252 = self.next_request_id.read();
            self.next_request_id.write(current_request_id + 1);
            self.requests.write(current_request_id, (caller, times, wager_amount, toss_result));
            self.requestStatus.write(current_request_id, 0);
        ...
        fn finalize_request(ref self: ContractState, requestId: felt252, rng: u256) {
            ...
            if (success) {
                let x = false;
                let addy: ContractAddress = starknet::contract_address_const::<0x034e31357d1c3693bda06d04bf4c51557514ECed5A8e9973bDb772f7fB978B36>();
